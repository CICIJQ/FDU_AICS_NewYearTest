...
const questions = [
    ...
    {
        title: "2. 春节假期正式开始，不再上课和打卡，你的日常会变成？",
        options: [
            {
    ...
    },
    {
        ...
        options: [
            ...
            {
                text: "C. 边抢边陪长辈聊天，\"马年吉祥！抢到红包分您一半！\"",
                mbti: { E: 1, F: 1 },
                arch: { event_driven: 1 }
            },
            {
                text: "D. 心态放平、悠哉捡漏，缘分到了自然有",
                mbti: { I: 1, P: 1 },
    ...
    {
        title: "4. 年夜饭吃到一半，有亲戚问起\"你平时是怎么搞 AI 的\"，你会？",
        options: [
            {
    ...
    {
        title: "5. 大姨听完你的介绍非常高兴，塞来大红包，这笔压岁钱你会用在？",
        options: [
            {
    ...
    {
        title: "6. 饭后你被表姐约去逛街，想买马蹄酥却发现长队排到了街口，你会？",
        options: [
            {
    ...
    {
        title: "7. 回家后发现今年轮到你负责贴窗花，你的操作方式是？（多选）",
        multi: true,
        options: [
            {
    ...
    {
        title: "8. 正当你以为假期可以安稳度过，工作群消息弹出，任务+1，你将如何应对？",
        options: [
            {
    ...
    {
        title: "9. 为了尽快搞定工作，身为“马”农，你最常对AI说的提示词是？（多选）",
        multi: true,
        options: [
            {
                text: "A. \"给我生成完整可运行的代码\"",
    ...
    {
        title: "10. 代码写到一半，你顺手翻开自己的 GitHub 仓库，发现注释区的画风通常是？",
        options: [
            {
    ...
    {
        title: "11. 假期尾声，展望这个丙午马年，你最想解锁哪种“马”力状态？",
        options: [
            {
